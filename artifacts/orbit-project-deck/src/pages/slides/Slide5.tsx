export default function Slide5() {
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-bg text-text orbit-paper">
      ...
      <div className="absolute left-[7vw] top-[10vh] text-[1.5vw] font-semibold uppercase tracking-[0.28em] text-primary">05</div>
      <div className="absolute left-[7vw] top-[20vh] w-[44vw]">
        ...
        <div className="mt-[6vh] space-y-[2.3vh]">
          <p className="m-0 font-body text-[2vw] leading-[1.25]">The responsive web MVP works in Safari</p>
          <p className="m-0 font-body text-[2vw] leading-[1.25]">Add Orbit to the iPhone Home Screen for an app-like experience</p>
          <p className="m-0 font-body text-[2vw] leading-[1.25]">The shared API and data model create a path to a native Expo app</p>
          <p className="m-0 font-body text-[2vw] leading-[1.25]">The next milestone is App Store readiness: native client, Apple Developer setup, assets, privacy details, and review</p>
        </div>
      </div>
