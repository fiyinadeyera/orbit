export default function Slide2() {
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-bg text-text orbit-paper">
      ...
      <div className="absolute left-[7vw] top-[10vh] text-[1.2vw] font-semibold uppercase tracking-[0.28em] text-primary">02</div>
      <div className="absolute left-[7vw] top-[22vh] w-[39vw]">
        ...
        <p className="mt-[4vh] max-w-[32vw] font-body text-[1.55vw] leading-[1.4] text-muted">The people we meet once or twice quickly lose their context.</p>
      </div>
      <div className="absolute right-[7vw] top-[17vh] w-[43vw]">
        <div className="flex items-start gap-[1.7vw] border-t-[0.12vw] border-primary/25 py-[3.2vh]">
          ...
          <p className="m-0 font-body text-[1.85vw] leading-[1.2]">Strong relationships maintain themselves</p>
        </div>
        <div className="flex items-start gap-[1.7vw] border-t-[0.12vw] border-primary/25 py-[3.2vh]">
          <span className="font-display text-[2.2vw] font-bold text-accent">02</span>
          <p className="m-0 font-body text-[1.85vw] leading-[1.2]">The people we meet once or twice quickly lose their context</p>
        </div>
        <div className="flex items-start gap-[1.7vw] border-t-[0.12vw] border-primary/25 py-[3.2vh]">
          <span className="font-display text-[2.2vw] font-bold text-accent">03</span>
          <p className="m-0 font-body text-[1.85vw] leading-[1.2]">Notes become scattered, stale, and hard to act on</p>
        </div>
        <div className="flex items-start gap-[1.7vw] border-y-[0.12vw] border-primary/25 py-[3.2vh]">
          ...
          <p className="m-0 font-body text-[1.85vw] font-semibold leading-[1.2] text-primary">Orbit turns relationship memory into something retrievable</p>
        </div>
      </div>
