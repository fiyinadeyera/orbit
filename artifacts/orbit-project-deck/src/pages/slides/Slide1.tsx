...
export default function Slide1() {
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-bg text-text orbit-paper">
      ...
      <div className="absolute left-[7vw] top-[9vh] text-[1.5vw] font-semibold uppercase tracking-[0.28em] text-primary">Orbit</div>
      ...
      <div className="absolute bottom-[8vh] left-[7vw] flex items-center gap-[1vw] text-[1.5vw] font-semibold uppercase tracking-[0.22em] text-primary">
        <span className="h-[0.65vw] w-[0.65vw] rounded-full bg-accent" />
        <span>Personal relationship intelligence</span>
      </div>
      <div className="absolute bottom-[8vh] right-[7vw] text-[1.5vw] font-semibold text-[#edf1e7]">01</div>
    </div>
  );
}
